...
<html>
    ...
    */ ?>
    ...
    <div style="box-sizing: border-box; padding: 20px; background: #f0f5f0; border-radius: 10px; max-width: 630px; width: 90%; margin-left: auto; margin-right: auto; font-family: 'Lexend', Sans-serif;">
        ...
        <p style="margin: 0 0 20px 0;">Thank you for shopping with us! Below are the details of your order</p>
        ...
        <hr>
        <br>
        <p style="margin: 0 0 20px 0;"><span style="font-weight: bold;">Download Your Invoice.</span><br>
