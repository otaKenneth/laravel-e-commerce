            ...
            >
                ...
                <button class="custom_btn_for_navbar_mobile dashboard_nav_btn navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-toggle="offcanvas">
                    ...
                    >
                        ...
                        @if (!is_null($chats))
                        <div id="container-chat-list">@include('admin.chats.chat-list-of-merchant')</div>
                        @endif
                    </div>
                    <div
                    ...
                    >
                        <div class="e-con-inner">
                            ...
                            <div id="container-chat-convo">@include('admin.chats.conversation-div')</div>
                            <div
