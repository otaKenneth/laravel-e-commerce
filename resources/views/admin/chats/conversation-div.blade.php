            ...
            <div
                ...
                <div class="e-con-inner">
                    <div
                        ...
                        data-element_type="widget"
                        data-widget_type="text-editor.default">
                        <div class="elementor-widget-container" style="background: #f0f0f0; padding: 10px 14px; border-radius: 16px 16px 16px 4px; margin-bottom: 8px;">
                            <p style="margin: 0;">{{$message->message}}</p>
                            <small style="display: block; font-size: 12px; color: #555; margin-top: 6px;">
                                {{ $message->created_at->setTimezone('Asia/Manila')->format('g:i A') }}
                            </small>
                        </div>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="e-con-inner">
                    <div
                        ...
                        data-element_type="widget"
                        data-widget_type="text-editor.default">
                        <div class="elementor-widget-container" style="padding: 10px 14px; border-radius: 16px 16px 4px 16px; margin-bottom: 8px;">
                            <p style="margin: 0;">{{$message->message}}</p>
                            <small style="display: block; font-size: 12px; color: #555; margin-top: 6px;">
                                {{ $message->created_at->setTimezone('Asia/Manila')->format('g:i A') }}
                            </small>
