            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-store">
                    <ul class="nav flex-column sub-menu" style="background: #fff !important; color: #5f7a61 !important">
                        ...
                        <li class="nav-item"> <a @if (Session::get('page') == 'chats')   style="background: #5f7a61 !important; color: #FFF !important" @else style="background: #fff !important; color: #5f7a61 !important" @endif class="nav-link" href="/admin/chats">Chats</a></li>
                    </ul>
                </div>
            </li>
