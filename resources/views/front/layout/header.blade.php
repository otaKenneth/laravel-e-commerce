...
<!-- Header -->
<header>
    <div class="w-full text-dark text-sm h-10 flex items-center text-center justify-center fixed top-0 z-50 font-bold" style="background-color: #ffffff; font-weight: bold; font-size: 14px ;"><span class="flex items-center" style="font-size: 18px">🛒</span> KAPITON IS IN EARLY DEVELOPMENT</div>
    <div data-elementor-type="header" data-elementor-id="34" class="elementor elementor-34 elementor-location-header"
        ...
        <div class="elementor-element elementor-element-41706f1 e-flex e-con-boxed e-con e-parent" data-id="41706f1"
                                    ...
                                    <form class="elementor-search-form" action="{{ url('products/search') }}"
                                        ...
                                        <div class="elementor-search-form__container">
                                            ...
                                            <input id="elementor-search-form-8e30943" placeholder="Search..."
                                                ...
                                                value="">
                                            <div id="fuse-results-8e30943" class="fuse-search-results-container">
                                            </div>
            ...
            <div class="elementor-element elementor-element-41706f1 e-flex e-con-boxed e-con e-parent"
                data-id="41706f1" data-element_type="container"
                data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;sticky&quot;:&quot;top&quot;,&quot;sticky_offset&quot;:86,&quot;sticky_offset_tablet&quot;:77,&quot;sticky_offset_mobile&quot;:73,&quot;container_type&quot;:&quot;flex&quot;,&quot;content_width&quot;:&quot;boxed&quot;,&quot;sticky_on&quot;:[&quot;desktop&quot;,&quot;tablet&quot;,&quot;mobile&quot;],&quot;sticky_effects_offset&quot;:0}"
                data-core-v316-plus="true">
                <div class="e-con-inner">
                                        ...
                                        <form class="elementor-search-form" action="{{ url('products/search') }}"
                                            ...
                                            <div class="elementor-search-form__container">
                                                ...
                                                <input id="elementor-search-form-31363e9" placeholder="Search..."
                                                    ...
                                                    name="search" value="">
                                                <div id="fuse-results-31363e9" class="fuse-search-results-container">
                                                </div>
                                                <div class="dialog-lightbox-close-button dialog-close-button"
                                                    role="button" tabindex="0">
                                                    <svg aria-hidden="true" class="e-font-icon-svg e-eicon-close"
                                                ...
                                                <span class="elementor-icon-list-icon">
                                                    <a href="{{ url('user/login-register') }}">
                                                        <svg aria-hidden="true"
                                                            class="e-font-icon-svg e-fas-user-lock"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function initializeAppSearch() {
                let productsData = [];
                try {
                    // 1. Fetch products data from the API
                    const response = await fetch(
                        "{{ route('api.products.searchable') }}");
                    if (!response.ok) {
                        throw new Error(`HTTP error! status: ${response.status} while fetching products.`);
                    }
                    productsData = await response.json();
                } catch (error) {
                    console.error("Fuse.js: Could not fetch products from API:", error);
                    return;
                }

                if (!productsData || productsData.length === 0) {
                    console.warn('Fuse.js: No products data received from API or data is empty.');
                    return;
                }
                ...
                // 3. Setup for both search inputs (function is defined below)
                setupFuseSearch('elementor-search-form-8e30943', 'fuse-results-8e30943', fuse, fuseOptions);
                setupFuseSearch('elementor-search-form-31363e9', 'fuse-results-31363e9', fuse, fuseOptions);
            }

            function setupFuseSearch(inputId, resultsId, fuseInstance, fuseOptionsRef) {
                const searchInput = document.getElementById(inputId);
                const resultsContainer = document.getElementById(resultsId);
                const searchForm = searchInput ? searchInput.closest('form.elementor-search-form') : null;
                const elementorSearchContainer = searchInput ? searchInput.closest(
                    '.elementor-search-form__container') : null;
                const closeButton = elementorSearchContainer ? elementorSearchContainer.querySelector(
                    '.dialog-lightbox-close-button') : null;
                ...
                searchInput.addEventListener('input', function(e) {
                    ...
                    if (searchTerm.length < fuseOptionsRef.minMatchCharLength) {
                        return;
                    }
                    ...
                    if (result.length > 0) {
                        ...
                        ul.className = 'fuse-results-list';
                        // Limit to top N results, e.g., 7
                        result.slice(0, 7).forEach(itemObj => {
                            ...
                            textContainer.className = 'fuse-result-text';

                            const nameSpan = document.createElement('span');
                            nameSpan.className = 'fuse-result-name';
                            ...
                            if (product.final_price !==
                                ...
                                priceSpan.className = 'fuse-result-price';
                ...
                if (searchForm) {
                    searchForm.addEventListener('submit', function(e) {
                        ...
                        if (result.length > 0) {
                            ...
                            // Optional: only go if match is decent
                            if (topMatch.score < 0.4) {
                                window.location.href = `/products/${topMatch.item.id}`;
                                return;
                            }
                        }
                ...
                document.addEventListener('click', function(event) {
                    if (resultsContainer && !resultsContainer.contains(event.target) && event.target !==
                        searchInput) {
                        resultsContainer.style.display = 'none';
                    }
                });
    ...
    <style>
        ...
        .fuse-search-results-container li {
            padding: 8px 12px;
            cursor: pointer;
        }

        .fuse-search-results-container li:hover {
            background: #f0f0f0;
        }
        ...
        .fuse-search-results-container ul.fuse-results-list {
            list-style: none;
            padding: 0;
            margin: 0;
        }

        .fuse-search-results-container ul.fuse-results-list li:last-child a {
            border-bottom: none;
        }

        .fuse-search-results-container .fuse-result-text {
            display: flex;
            flex-direction: column;
        }

        .fuse-search-results-container .fuse-result-name {
            font-weight: 600;
            font-size: 0.9em;
            color: #2c3e50;
            margin-bottom: 2px;
        ...
        .fuse-search-results-container .fuse-result-price {
            font-size: 0.85em;
            color: #7f8c8d;
        }
    </style>
