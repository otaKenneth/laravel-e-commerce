...
<!-- Header -->
<header>
    <div class="w-full text-dark text-sm h-10 flex items-center text-center justify-center fixed top-0 z-50 font-bold" style="background-color: #ffffff; font-weight: bold; font-size: 14px ;"><span style="font-size: 18px">🛒</span> KAPITON IS IN EARLY DEVELOPMENT</div>
