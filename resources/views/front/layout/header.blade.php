...
<header id="pageHeader" class="sticky top-0 left-0 w-full" >
    <div id="earlyDevHeader" class="w-full text-dark text-sm h-10 flex items-center text-center justify-center font-bold" style="background-color: #ffffff; font-weight: bold; font-size: 14px; font-family: 'Montserrat', sans-serif;">
    <span class="flex items-center" style="font-size: 18px">🛒</span> KAPITON IS IN EARLY DEVELOPMENT
    </div>
