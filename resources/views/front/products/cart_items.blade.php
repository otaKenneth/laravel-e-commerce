                        ...
                        <td>
                            <div class="qty-and-remove">
                                <div class="quantity-div">
                                    <button class="qty-cart minus" data-cartId="{{ $item["id"] }}" data-qty="{{ $item['quantity'] }}">-</button>
            ...
            <div class="e-con-inner">
                ...
                >
                    <div class="elementor-widget-container">
                        ...
                        <form id="applyCoupon" action="javascript:;" name="COUPON CODE" user="{{ Auth::check() }}">
                ...
                >
                    <div class="e-con-inner">
                        ...
                        >
                            <div class="elementor-widget-container">
                                <div class="elementor-button-wrapper">
                                    <a class="elementor-button elementor-button-link elementor-size-sm" href="{{ url('/checkout') }}">
                                        <span class="elementor-button-content-wrapper">
                    ...
                    <div class="elementor-widget-container">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="padding-top: 40px">
                                    <b>₱<span class="grand_total">{{number_format($total_price, 2)}}</span></b>
                                </td>
                            </tr>
                        </table>
                    </div>
