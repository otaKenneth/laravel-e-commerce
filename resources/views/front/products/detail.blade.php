...
<div
    ...
    @include('front.layout.initiate_chat')
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="elementor-widget-container">
                                                                    <img
                                                                        ...
                                                                        alt=""
                                                                        srcset="
                                                                        {{ $getImage('front/images/product/', 'no-available-image.jpg') }} 522w, 
                                                                        {{ $getImage('front/images/product/', 'no-available-image.jpg') }} 300w, 
                                                                        {{ $getImage('front/images/product/', 'no-available-image.jpg') }} 150w"
                                                                        sizes="(max-width: 522px) 100vw, 522px"
                                                                        style="width: 100%; max-width: 522px; height: auto; object-fit: contain; display: block;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    @for ($x = 0; $x < 5; $x++)
                                        ...
                                        <span class="font-family-body">No reviews</span>
                                        @break
                                        @else
                                        <div class="e-icon">
                ...
                <div
                    ...
                    <div class="e-con-inner">
                        ...
                        <div
                            ...
                            data-widget_type="heading.default">
                            <div class="elementor-widget-container">
                                <h2 class="elementor-secondary-title discount-price elementor-size-default">₱{{$getDiscountPrice}}</h2>
                            </div>
                        </div>
                        <div
                            ...
                            data-widget_type="heading.default">
                            <div class="elementor-widget-container">
                                <h2 class="elementor-secondary-title product-price elementor-size-default">₱{{$productDetails['product_price']}}</h2>
                            </div>
                        </div>
                        @else
                        <div
                ...
                <div
                    ...
                    <div class="elementor-widget-container">
                        ...
                        <p class="font-family-body">{{$productDetails['description']}}</p>
                    </div>
                </div>
                <div
                                    ...
                                    <div class="elementor-form-fields-wrapper elementor-labels-">
                                        ...
                                        <div class="elementor-field-type-select elementor-field-group elementor-column elementor-field-group-field_cfabe28 elementor-col-30 elementor-field-required">
                                            ...
                                            <div class="elementor-field elementor-select-wrapper remove-before ">
                                                ...
                                                <select name="variation" id="form-field-field_cfabe28" class="elementor-field-textual font-family-body elementor-size-sm" aria-required="true">
                                        ...
                                        <span class="stock--label font-family-body">Stock: <b id="curr-stock-val">{{ $curStock }}</b></span>
