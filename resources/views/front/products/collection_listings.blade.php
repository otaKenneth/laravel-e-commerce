            ...
            <div class="e-con-inner">
                ...
                <div id="container-product_list" class="product_list_container">
                    ...
                    @foreach ($collection as $product)
                        ...
                        @endphp
                        <div class="elementor-element elementor-element-80f00c9 e-con-full e-flex elementor-invisible e-con e-child single_product_card"
                                                ...
                                                <div class="elementor-element elementor-element-67825cd elementor-widget elementor-widget-heading"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        <h5 class="elementor-heading-title elementor-size-default">
                                                            {{ $product->vendor->vendorbusinessdetails->shop_name ?? '' }}</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </a>
                                                    ...
                                                    @for ($x = 0; $x < 5; $x++)
                                                        <div class="e-icon">
                                                            <div class="e-icon-wrapper e-icon-marked"
                                                                style="{{ $x < $marked && $marked > 0 ? '' : '--e-rating-icon-marked-width: 0%;' }}">
