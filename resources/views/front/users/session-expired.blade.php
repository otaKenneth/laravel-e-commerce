{{-- This page is rendered by the session expired() method inside Front/indexController.php --}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12" align="center">
                    ...
                    <div class="svgrepo">
                        <svg width="100%" height="100%" viewBox="0 0 48 48" version="1" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 48 48">
                            <circle fill="#5f7a61" cx="17" cy="17" r="14"/>
                            ...
                            <circle fill="#5f7a61" cx="17" cy="17" r="1"/>
                    ...
                    <p>Please click <a style="color: black; font-weight: bold;" href="{{ url('user/login-register') }}">this</a> link to login.</p>
                </div>
            </div>
        </div>
    </div>
