            ...
            >
                ...
                >
                    <div class="elementor-widget-container">
                        <h1 class="elementor-heading-title elementor-size-default font-h1">FORGOT YOUR PASSWORD</h1>
                    </div>
                </div>
                <div
                    ...
                    <div class="e-con-inner">
                        ...
                        >
                            <div class="elementor-widget-container">
                                ...
                                <form id="forgotForm" method="post" action="javascript:;" name="Reset Password">
                                    @csrf
