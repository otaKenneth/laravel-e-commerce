...
<div
    ...
    data-elementor-id="656"
    class="elementor elementor-656"
    data-elementor-post-type="page"
>
    <div
        class="elementor-element elementor-element-c7022e5 e-flex e-con-boxed e-con e-parent"
        data-id="c7022e5"
    ...
    >
        <div class="e-con-inner">
            <div
                class="elementor-element elementor-element-53f764a e-con-full e-flex e-con e-child"
                data-id="53f764a"
                data-element_type="container"
                data-settings="{&quot;content_width&quot;:&quot;full&quot;,&quot;container_type&quot;:&quot;flex&quot;}"
            >
                <div
                    class="elementor-element elementor-element-ab49747 elementor-invisible elementor-widget elementor-widget-heading"
                    data-id="ab49747"
                ...
                >
                    <div class="elementor-widget-container">
                        <h1 class="elementor-heading-title elementor-size-default font-h1">CREATE ACCOUNT</h1>
                    </div>
                </div>
                <div
                    class="elementor-element elementor-element-64df233 login-container e-flex e-con-boxed elementor-invisible e-con e-child"
                    data-id="64df233"
                    data-element_type="container"
                ...
                >
                    <div class="e-con-inner">
                        <div
                            class="elementor-element elementor-element-b9ac8ae elementor-button-align-stretch elementor-widget elementor-widget-form"
                            data-id="b9ac8ae"
                            data-element_type="widget"
                        ...
                        >
                            <div class="elementor-widget-container">
                                ...
                                <form id="registerForm" method="post" action="javascript:;" name="Register">
                                    <div id="register-success" class="message-form"></div>
                                    @csrf
                                    <input type="hidden" name="post_id" value="656">
                                    <input type="hidden" name="form_id" value="b9ac8ae">
                                    <input type="hidden" name="referer_title" value="Create Account">
                                    <input type="hidden" name="queried_id" value="656">
                                    <div class="elementor-form-fields-wrapper elementor-labels-">
                                        <div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_f4dd461 elementor-col-100 elementor-field-required">
                                            ...
                                            <input
                                                ...
                                                aria-required="true"
                                            >
                                            <p id="register-first_name" style="color: red"></p>
                                        </div>
                                        ...
                                        <div class="elementor-field-type-text elementor-field-group elementor-column elementor-field-group-field_11df834 elementor-col-100 elementor-field-required">
                                            ...
                                            <input
                                                ...
                                                aria-required="true"
                                            >
                                            <span id="register-mobile" style="color: red"></span>
                                        </div>
                                        <div class="elementor-field-type-email elementor-field-group elementor-column elementor-field-group-email elementor-col-100 elementor-field-required">
                                            ...
                                            <input
                                                ...
                                                aria-required="true"
                                            >
                                            <span id="register-email" style="color: red"></span>
                                        </div>
                        ...
                        <div
                            class="elementor-element elementor-element-437b333 elementor-widget elementor-widget-text-editor"
                            data-id="437b333"
                            data-element_type="widget"
