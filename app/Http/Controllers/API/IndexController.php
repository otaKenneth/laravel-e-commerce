...
class IndexController extends Controller
{
    public function index() {
        ...
        return response()->json([$sliderBanners, $fixBanners, $newProducts, $bestSellers, $discountedProducts, $featuredProducts, $meta_title, $meta_description, $meta_keywords, $categories], 200);
    }
}
