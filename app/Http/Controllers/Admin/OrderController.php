...
class OrderController extends Controller
{
    ...
    public function viewOrderInvoice($order_id) { // Route Parameters: Required Parameters: https://laravel.com/docs/9.x/routing#required-parameters
        ...
        // dd($orderDetails);
        $userDetails = \App\Models\User::where('id', $orderDetails['user_id'])->first()->toArray(); // details of the user who made the order
    ...
    public function viewPDFInvoice($order_id) { // Route Parameters: Required Parameters: https://laravel.com/docs/9.x/routing#required-parameters
        ...
        <head>
            ...
            <style>
                ...
                .box-bill-to, .box-invoice-info {
                    box-sizing: border-box;
                }

                .box-bill-to table, .box-invoice-info table {
                    width: 100%;
                    border-collapse: collapse;
                }

                .box-bill-to td, .box-invoice-info td {
                ...
                .signature-section, .totals-section {
                    display: flex;
                    justify-content: flex-start;
                    align-items: flex-start;
                    flex-wrap: wrap;
        ...
        <body>
            <div class="container">
                <div class="header">
                    ...
                    <strong>Kapiton Solutions Inc.</strong><br>
                    Commercial Unit 5 Centro Towers<br>
                    138 N. Domingo Street<br>
                    Kaunlaran, Quezon City<br>
                    Philippines<br>
                    kapiton.marketplace@gmail.com
                </div>
                ...
                <div class="flex">
                    <div class="box-bill-to">
                        <table>
                            ...
                            <tr><td>' . $orderDetails['address'] . ', ' . $orderDetails['city'] . ', ' . $orderDetails['state'] . ', ' . $orderDetails['country'] . '-' . $orderDetails['pincode'] . '</td></tr>
                        </table>
                    </div>
                    <div class="box-invoice-info">
                        <table>
                            <tr><td><strong>Invoice #:</strong> ' . $orderDetails['id'] . '</td></tr>
                            <tr><td><strong>Invoice Date:</strong> ' . date('Y-m-d h:i:s', strtotime($orderDetails['created_at'])) . '</td></tr>
                        </table>
                    </div>
                </div>
        ...
        foreach ($orderDetails['orders_products'] as $product) {
            ...
            $invoiceHTML .= '
                        <tr>
                            ...
                            <td class="unit">PHP ' . number_format($product['product_price'], 2) . '</td>
                            <td class="total">PHP ' . number_format($lineTotal, 2) . '</td>
                        </tr>';
        }

        // Final Calculations
        $vat = $subTotal * 0.12;
        $shipping = $orderDetails['shipping_charges'] ?? 0;
        $discount = $orderDetails['coupon_amount'] ?? 0;
        $grandTotal = $subTotal + $vat + $shipping - $discount;

        $invoiceHTML .= '
                    </tbody>
                </table>

                <!-- Signature Section (side by side with Total Section) -->
                <div class="flex signature-section">
                    <div class="signature"><br><br>
                        Represented by:<br><br>
                        Kapiton Solutions, Inc.<br>
                        Kenneth Arnold Tan<br>
                        <hr>
                    </div>
                    <div class="totals-section">
                        <table class="totals">
                            ...
                            <tr>
                                ...
                                <td class="right">PHP ' . number_format($vat, 2) . '</td>
                            </tr>
                            <tr>
                                <td class="label">Shipping Fee</td>
                                <td class="right">PHP ' . number_format($shipping, 2) . '</td>
                            </tr>
                            <tr>
                                <td class="label">Discount/Vouchers</td>
                                <td class="right">-PHP ' . number_format($discount, 2) . '</td>
                            </tr>
                            <tr>
                                <td class="label"><strong>Total</strong></td>
                                <td class="right"><strong>PHP ' . number_format($grandTotal, 2) . '</strong></td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <br><hr>
                <div class="footer">
                    Commercial Unit 5 Centro Towers 138 N. Domingo Street, Kaunlaran, Quezon City, Metro Manila<br>
                    e-mail: kapiton.marketplace@gmail.com / 
                    <a href="https://kapiton.store" target="_blank">https://kapiton.store</a>
                </div>
            </div>
        </body>
        </html>';
            ...
            //                 <h2 class="bill_from">BILL FROM</h2)
            //                 <h2 class="title">Kapiton Solutions Inc.</h2>
            //                 <p>
            //                     Kapiton Solutions Inc.
            //                     Commercial Unit 5 Centro Towers
            //                     138 N. Domingo Street
