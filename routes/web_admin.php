...
Route::middleware(['web'])->prefix('/admin')->namespace('App\Http\Controllers\Admin')->group(function() {
    ...
    Route::group(['middleware' => ['admin']], function() { // using our 'admin' guard (which we created in auth.php)
        ...
        Route::get('append-categories-level', 'CategoryController@appendCategoryLevel'); // Show Categories <select> <option> depending on the choosed Section (show the relevant categories of the choosed section) using AJAX in admin/js/custom.js in append_categories_level.blade.php page
        ...
        // Attributes
        Route::match(['get', 'post'], 'add-edit-attributes/{product}', 'ProductsController@addAttributes'); // GET request to render the add_edit_attributes.blade.php view, and POST request to submit the <form> in that view
        ...
        Route::get('orders/{order}/refund-log-details/{order_log}', 'OrderController@orderRefundDetail'); 
        ...
        Route::post('finance/generate-weekly-report', 'ReportsController@generateWeeklyReport');
        Route::post('finance/save-weekly-report', 'ReportsController@saveWeeklyReport');
        ...
        Route::get('bank/details', 'VendorBankController@index')->name('admin.bank.details');
